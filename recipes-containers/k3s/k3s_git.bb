...
do_install() {
        ...
        # We want to use the containerdd provided ctr
...
RDEPENDS_${PN} = "k3s-cni conntrack-tools runc-opencontainers coreutils findutils iptables iproute2 ipset virtual/containerd"
