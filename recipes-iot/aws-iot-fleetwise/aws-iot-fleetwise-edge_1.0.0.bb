...
LICENSE = "ASL-1.0"
LIC_FILES_CHKSUM = "file://${S}/LICENSE;md5=79ba3a8bc4e89e76f90b0dadbf304749"
NO_GENERIC_LICENSE[ASL-1.0] = "${S}/LICENSE"
...
SRC_URI = "git://github.com/aws/aws-iot-fleetwise-edge.git;protocol=https;branch=main;name=fwe \
           git://github.com/hartkopp/can-isotp.git;protocol=https;branch=master;name=isotp;destsuffix=isotp \
           "
